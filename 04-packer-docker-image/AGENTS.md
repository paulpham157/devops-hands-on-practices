...
These instructions apply when an AI agent helps a learner study `04-packer-docker-image/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `04-packer-docker-image/README.md` from top to bottom.
...
- Follow the commands in `04-packer-docker-image/README.md`; do not invent a different setup path.

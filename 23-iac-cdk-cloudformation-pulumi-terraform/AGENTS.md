...
These instructions apply when an AI agent helps a learner study `23-iac-cdk-cloudformation-pulumi-terraform/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `23-iac-cdk-cloudformation-pulumi-terraform/README.md` from top to bottom.
...
- Follow the commands in `23-iac-cdk-cloudformation-pulumi-terraform/README.md`; do not invent a different setup path.

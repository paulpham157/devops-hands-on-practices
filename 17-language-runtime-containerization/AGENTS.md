...
These instructions apply when an AI agent helps a learner study `17-language-runtime-containerization/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `17-language-runtime-containerization/README.md` from top to bottom.
...
- Follow the commands in `17-language-runtime-containerization/README.md`; do not invent a different setup path.

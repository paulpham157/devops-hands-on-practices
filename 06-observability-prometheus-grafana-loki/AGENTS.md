...
These instructions apply when an AI agent helps a learner study `06-observability-prometheus-grafana-loki/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `06-observability-prometheus-grafana-loki/README.md` from top to bottom.
...
- Follow the commands in `06-observability-prometheus-grafana-loki/README.md`; do not invent a different setup path.

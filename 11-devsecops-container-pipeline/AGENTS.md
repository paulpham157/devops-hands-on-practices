...
These instructions apply when an AI agent helps a learner study `11-devsecops-container-pipeline/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `11-devsecops-container-pipeline/README.md` from top to bottom.
...
- Follow the commands in `11-devsecops-container-pipeline/README.md`; do not invent a different setup path.

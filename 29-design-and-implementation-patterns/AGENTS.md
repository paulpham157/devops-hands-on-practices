...
These instructions apply when an AI agent helps a learner study `29-design-and-implementation-patterns/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `29-design-and-implementation-patterns/README.md` from top to bottom.
...
- Follow the commands in `29-design-and-implementation-patterns/README.md`; do not invent a different setup path.

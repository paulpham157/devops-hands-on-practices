...
For this Docker course, treat OpenTofu as a practical way to describe desired infrastructure and let the tool calculate the changes needed to reach that desired state.
...
```bash
cd hands-on-practice/10-opentofu-docker-module

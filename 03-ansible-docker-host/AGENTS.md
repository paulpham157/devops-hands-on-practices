...
These instructions apply when an AI agent helps a learner study `03-ansible-docker-host/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `03-ansible-docker-host/README.md` from top to bottom.
...
- Follow the commands in `03-ansible-docker-host/README.md`; do not invent a different setup path.

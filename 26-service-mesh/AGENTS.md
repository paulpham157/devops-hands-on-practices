...
These instructions apply when an AI agent helps a learner study `26-service-mesh/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `26-service-mesh/README.md` from top to bottom.
...
- Follow the commands in `26-service-mesh/README.md`; do not invent a different setup path.

...
These instructions apply when an AI agent helps a learner study `36-chef-infra-automation/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `36-chef-infra-automation/README.md` from top to bottom.
...
- Follow the commands in `36-chef-infra-automation/README.md`; do not invent a different setup path.

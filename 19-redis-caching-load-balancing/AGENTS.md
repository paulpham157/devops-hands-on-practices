...
These instructions apply when an AI agent helps a learner study `19-redis-caching-load-balancing/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `19-redis-caching-load-balancing/README.md` from top to bottom.
...
- Follow the commands in `19-redis-caching-load-balancing/README.md`; do not invent a different setup path.

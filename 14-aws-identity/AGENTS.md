...
These instructions apply when an AI agent helps a learner study `14-aws-identity/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `14-aws-identity/README.md` from top to bottom.
...
- Follow the commands in `14-aws-identity/README.md`; do not invent a different setup path.

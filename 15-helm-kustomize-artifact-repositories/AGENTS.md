...
These instructions apply when an AI agent helps a learner study `15-helm-kustomize-artifact-repositories/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `15-helm-kustomize-artifact-repositories/README.md` from top to bottom.
...
- Follow the commands in `15-helm-kustomize-artifact-repositories/README.md`; do not invent a different setup path.

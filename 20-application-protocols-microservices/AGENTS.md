...
These instructions apply when an AI agent helps a learner study `20-application-protocols-microservices/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `20-application-protocols-microservices/README.md` from top to bottom.
...
- Follow the commands in `20-application-protocols-microservices/README.md`; do not invent a different setup path.

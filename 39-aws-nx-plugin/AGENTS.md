...
These instructions apply when an AI agent helps a learner study `39-aws-nx-plugin/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `39-aws-nx-plugin/README.md` from top to bottom.
...
- Follow the commands in `39-aws-nx-plugin/README.md`; do not invent a different setup path.

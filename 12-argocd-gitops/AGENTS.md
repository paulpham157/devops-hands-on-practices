...
These instructions apply when an AI agent helps a learner study `12-argocd-gitops/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `12-argocd-gitops/README.md` from top to bottom.
...
- Follow the commands in `12-argocd-gitops/README.md`; do not invent a different setup path.

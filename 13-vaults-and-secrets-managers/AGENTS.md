...
These instructions apply when an AI agent helps a learner study `13-vaults-and-secrets-managers/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `13-vaults-and-secrets-managers/README.md` from top to bottom.
...
- Follow the commands in `13-vaults-and-secrets-managers/README.md`; do not invent a different setup path.

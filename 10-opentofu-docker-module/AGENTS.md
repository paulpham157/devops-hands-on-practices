...
These instructions apply when an AI agent helps a learner study `10-opentofu-docker-module/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `10-opentofu-docker-module/README.md` from top to bottom.
...
- Follow the commands in `10-opentofu-docker-module/README.md`; do not invent a different setup path.

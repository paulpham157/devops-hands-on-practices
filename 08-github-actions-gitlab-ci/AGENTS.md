...
These instructions apply when an AI agent helps a learner study `08-github-actions-gitlab-ci/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `08-github-actions-gitlab-ci/README.md` from top to bottom.
...
- Follow the commands in `08-github-actions-gitlab-ci/README.md`; do not invent a different setup path.

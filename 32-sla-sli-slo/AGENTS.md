...
These instructions apply when an AI agent helps a learner study `32-sla-sli-slo/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `32-sla-sli-slo/README.md` from top to bottom.
...
- Follow the commands in `32-sla-sli-slo/README.md`; do not invent a different setup path.

...
These instructions apply when an AI agent helps a learner study `05-terraform-docker-container/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `05-terraform-docker-container/README.md` from top to bottom.
...
- Follow the commands in `05-terraform-docker-container/README.md`; do not invent a different setup path.

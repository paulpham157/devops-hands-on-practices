...
These instructions apply when an AI agent helps a learner study `09-k3s-local-cluster/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `09-k3s-local-cluster/README.md` from top to bottom.
...
- Follow the commands in `09-k3s-local-cluster/README.md`; do not invent a different setup path.

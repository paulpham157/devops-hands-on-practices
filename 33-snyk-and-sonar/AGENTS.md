...
These instructions apply when an AI agent helps a learner study `33-snyk-and-sonar/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `33-snyk-and-sonar/README.md` from top to bottom.
...
- Follow the commands in `33-snyk-and-sonar/README.md`; do not invent a different setup path.

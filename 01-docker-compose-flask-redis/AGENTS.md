...
These instructions apply when an AI agent helps a learner study `01-docker-compose-flask-redis/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `01-docker-compose-flask-redis/README.md` from top to bottom.
...
- Follow the commands in `01-docker-compose-flask-redis/README.md`; do not invent a different setup path.

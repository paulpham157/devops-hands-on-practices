...
These instructions apply when an AI agent helps a learner study `31-backend-for-frontend/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `31-backend-for-frontend/README.md` from top to bottom.
...
- Follow the commands in `31-backend-for-frontend/README.md`; do not invent a different setup path.

...
These instructions apply when an AI agent helps a learner study `25-openshift-gke-eks-aks-ecs-fargate/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `25-openshift-gke-eks-aks-ecs-fargate/README.md` from top to bottom.
...
- Follow the commands in `25-openshift-gke-eks-aks-ecs-fargate/README.md`; do not invent a different setup path.

...
| Worker node management | platform-dependent | Standard or Autopilot modes | managed node groups, self-managed nodes, Fargate profiles, or Auto Mode | node pools or AKS Automatic | EC2 or Fargate | no worker nodes to manage |

...
These instructions apply when an AI agent helps a learner study `18-linux-unix-fundamentals/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `18-linux-unix-fundamentals/README.md` from top to bottom.
...
- Follow the commands in `18-linux-unix-fundamentals/README.md`; do not invent a different setup path.

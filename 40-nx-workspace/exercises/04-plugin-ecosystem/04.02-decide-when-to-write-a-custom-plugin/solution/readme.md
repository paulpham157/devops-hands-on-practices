# Solution: Decide When To Write A Custom Plugin

1. Custom plugin may fit because repeated scaffolding can justify automation.
2. No plugin is likely better; a one-off script does not justify plugin maintenance.

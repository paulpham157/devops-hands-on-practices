...
These instructions apply when an AI agent helps a learner study `07-jenkins-ci-pipeline/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `07-jenkins-ci-pipeline/README.md` from top to bottom.
...
- Follow the commands in `07-jenkins-ci-pipeline/README.md`; do not invent a different setup path.

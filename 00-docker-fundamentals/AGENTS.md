...
These instructions apply when an AI agent helps a learner study `00-docker-fundamentals/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `00-docker-fundamentals/README.md` from top to bottom.
...
- Follow the commands in `00-docker-fundamentals/README.md`; do not invent a different setup path.

...
These instructions apply when an AI agent helps a learner study `16-opentelemetry-jaeger-datadog/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `16-opentelemetry-jaeger-datadog/README.md` from top to bottom.
...
- Follow the commands in `16-opentelemetry-jaeger-datadog/README.md`; do not invent a different setup path.

...
These instructions apply when an AI agent helps a learner study `35-puppet-configuration-management/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `35-puppet-configuration-management/README.md` from top to bottom.
...
- Follow the commands in `35-puppet-configuration-management/README.md`; do not invent a different setup path.

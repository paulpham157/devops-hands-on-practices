...
These instructions apply when an AI agent helps a learner study `37-teamcity-ci-pipelines/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `37-teamcity-ci-pipelines/README.md` from top to bottom.
...
- Follow the commands in `37-teamcity-ci-pipelines/README.md`; do not invent a different setup path.

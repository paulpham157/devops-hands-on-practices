...
These instructions apply when an AI agent helps a learner study `38-openstack-private-cloud/`. Follow the root `AGENTS.md` for the general learner workflow and use this file for lesson-specific context.

## Start Here

1. Read `38-openstack-private-cloud/README.md` from top to bottom.
...
- Follow the commands in `38-openstack-private-cloud/README.md`; do not invent a different setup path.
